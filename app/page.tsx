          ...
          <div className="max-w-[1280px] mx-auto px-container-padding grid lg:grid-cols-2 gap-12 items-center">
            <div className="z-10 text-center lg:text-left">
              ...
              <p className="font-body-lg text-body-lg text-secondary mb-8 max-w-xl mx-auto lg:mx-0">
                Transform your sales calls into data-driven insights. Get real-time sentiment
                analysis, automated BANT qualification, and executive summaries to close deals
                faster.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link
                  href="/dashboard"
                  className="bg-primary-container text-on-primary-container font-label-bold text-label-bold px-8 py-4 rounded-2xl shadow-nature hover:shadow-lg transition-all flex items-center justify-center gap-2 uppercase no-underline"
                >
                  Go to Dashboard <span className="material-symbols-outlined">arrow_forward</span>
                </Link>
                <Link
                  href="/dashboard"
                  className="border-2 border-primary text-primary font-label-bold text-label-bold px-8 py-4 rounded-2xl hover:bg-primary-container/10 transition-all uppercase no-underline text-center"
                >
                  Our Solutions
                </Link>
              </div>
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center">
              ...
              <div className="relative w-full max-w-[500px] aspect-square">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative h-32 rounded-xl overflow-hidden border border-surface-container-high">
                      ...
                      <div className="absolute bottom-3 left-3 right-3 flex justify-between items-end">
                        <span className="text-label-sm font-bold text-on-background">
                          Executive Summary Ready
                        </span>
                        <Link
                          href="/dashboard"
                          className="bg-on-background text-white text-[10px] px-3 py-1 rounded-full uppercase font-bold no-underline"
                        >
                          View
                        </Link>
                      </div>
                ...
                <div className="absolute -top-4 -right-4 bg-white p-4 rounded-2xl shadow-lg border border-surface-container-high flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-label-bold text-secondary uppercase m-0">
                      Win Rate
                    </p>
        ...
        <section className="py-section-gap bg-surface-container-low">
          <div className="max-w-[1280px] mx-auto px-container-padding">
            <div className="text-center mb-16">
              <h2 className="font-title text-headline-xl text-on-background mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-gutter">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-nature shadow-nature-hover transition-all border border-surface-container-high group">
                ...
                <h3 className="font-title text-headline-lg-mobile text-on-background mb-4">
                  Sentiment Analysis
                </h3>
                <p className="text-secondary font-body-md mb-6">
                  Real-time emotional tracking detects hesitation, excitement, or skepticism,
                  allowing reps to pivot their strategy mid-call.
                </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-nature shadow-nature-hover transition-all border border-surface-container-high group">
                ...
                <p className="text-secondary font-body-md mb-6">
                  Automated tracking of Budget, Authority, Need, and Timeline ensures no prospect
                  slips through the cracks without full validation.
                </p>
                <ul className="space-y-3 p-0 list-none">
                  <li className="flex items-center gap-2 text-label-sm font-medium">
                    <span className="material-symbols-outlined text-primary text-[18px]">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-nature shadow-nature-hover transition-all border border-surface-container-high group">
                ...
                <p className="text-secondary font-body-md mb-6">
                  Ditch the manual notes. Our AI generates concise, action-oriented summaries
        ...
        <section className="py-section-gap overflow-hidden bg-background">
          <div className="max-w-[1280px] mx-auto px-container-padding">
            <div className="flex flex-col md:flex-row gap-16 items-center">
              ...
              <div className="md:w-1/2">
                <h2 className="font-title text-headline-xl text-on-background mb-6">
                  Designed for Growth Optimism
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 p-4 rounded-xl hover:bg-surface-container-low transition-colors">
                    ...
                    <div>
                      <p className="font-label-bold text-label-bold text-on-background m-0">
                        Sustainable Efficiency
                      </p>
                      <p className="text-label-sm text-secondary m-0">
                        Reduce call prep and post-call tasks by up to 60%.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4 p-4 rounded-xl hover:bg-surface-container-low transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-label-sm text-secondary m-0">
                        Our models are trained on high-performance sales frameworks.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-section-gap max-w-[1280px] mx-auto px-container-padding">
          <div className="bg-on-background rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="font-title text-headline-xl text-white mb-6">
                Ready to close smarter?
              </h2>
              <p className="font-body-lg text-body-lg text-surface-container-high max-w-xl mx-auto mb-10">
                Join the next generation of sales leaders who use Talklytics to turn every
                conversation into a conversion.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  href="/dashboard"
                  className="bg-primary-container text-on-primary-container font-label-bold text-label-bold px-10 py-5 rounded-2xl hover:opacity-90 transition-all uppercase tracking-wider no-underline text-center"
                >
                  Get Started Free
                </Link>
                <Link
                  href="/dashboard"
                  className="bg-white/10 text-white font-label-bold text-label-bold px-10 py-5 rounded-2xl hover:bg-white/20 transition-all uppercase tracking-wider border border-white/20 no-underline text-center"
                >
                  Watch Demo
                </Link>
              </div>
              <p className="mt-8 text-secondary/70 text-label-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-gutter mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-4">
                <a
                  className="w-10 h-10 rounded-full bg-white border border-surface-container-high flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all no-underline"
                  href="#"
                >
            ...
            <div>
              <h4 className="font-label-bold text-label-bold text-on-background mb-6 uppercase tracking-wider">
                Product
              </h4>
              <ul className="space-y-4 p-0 list-none">
                <li>
                  <Link
                    className="font-body-md text-body-md text-secondary hover:text-primary transition-transform duration-200 hover:translate-x-1 block no-underline"
                    href="/dashboard"
                  >
                    Product Tour
                  </Link>
